...
import { jobAtom, messagingAtom, networkAtom, notificationAtom, totalCountSelector } from "./atoms1";
import { useMemo } from "react";

function App5DynamicTopBarNotificaions() {
  return(
    <RecoilRoot>
      <MainApp/>
    </RecoilRoot>
...
export default App5DynamicTopBarNotificaions;